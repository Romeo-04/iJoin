        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if(auth()->user()->role === 'admin')
                        ...
                        <x-nav-link :href="route('admin.verify')" :active="request()->routeIs('admin.verify')">
                            {{ __('Verify Tickets') }}
                        </x-nav-link>
                    @endif
                </div>
            ...
            <div class="-me-2 flex items-center sm:hidden space-x-2">
                ...
                <button id="theme-toggle-mobile" type="button" 
                        class="text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2 transition-colors">
                    <!-- Moon icon (shown in light mode) -->
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if(auth()->user()->role === 'admin')
                ...
                <x-responsive-nav-link :href="route('admin.verify')" :active="request()->routeIs('admin.verify')">
                    {{ __('Verify Tickets') }}
                </x-responsive-nav-link>
            @endif
        </div>
